...
namespace earnings2_model_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 30> locations_array__ =
  {" (found before start of program)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 18, column 2 to column 18)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 19, column 2 to column 22)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 28, column 2 to line 32, column 77)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 2, column 2 to column 17)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 3, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 3, column 2 to column 24)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 4, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 4, column 2 to column 20)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 5, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 5, column 2 to column 24)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 6, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 6, column 2 to column 21)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 7, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 7, column 2 to column 19)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 8, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 8, column 2 to column 18)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 9, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 9, column 2 to column 21)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 10, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 10, column 2 to column 17)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 11, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 11, column 2 to column 19)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 12, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 12, column 2 to column 18)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 13, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 13, column 2 to column 24)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 14, column 9 to column 10)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 14, column 2 to column 20)",
  " (in '/mnt/c/Windows/System32/example-models-master/ARM/Ch.25/earnings2.stan', line 15, column 2 to column 29)"};
class earnings2_model final : public model_base_crtp<earnings2_model> {
 private:
  int N;
  ...
  Eigen::Matrix<double,-1,1> interest_data__;
  ...
  Eigen::Map<Eigen::Matrix<double,-1,1>> interest{nullptr, 0};
 ...
 public:
  ~earnings2_model() {}
  earnings2_model(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "earnings2_model_namespace::earnings2_model";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("interest", "N", N);
      current_statement__ = 18;
      context__.validate_dims("data initialization", "interest", "double",
        std::vector<size_t>{static_cast<size_t>(N)});
      interest_data__ = Eigen::Matrix<double,-1,1>::Constant(N,
                          std::numeric_limits<double>::quiet_NaN());
      new (&interest)
        Eigen::Map<Eigen::Matrix<double,-1,1>>(interest_data__.data(), N);
      {
        std::vector<local_scalar_t__> interest_flat__;
        current_statement__ = 18;
        interest_flat__ = context__.vals_r("interest");
        current_statement__ = 18;
        pos__ = 1;
        current_statement__ = 18;
        for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
          current_statement__ = 18;
          stan::model::assign(interest, interest_flat__[(pos__ - 1)],
            "assigning variable interest", stan::model::index_uni(sym1__));
          current_statement__ = 18;
          pos__ = (pos__ + 1);
        }
      }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "earnings2_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      Eigen::Matrix<local_scalar_t__,-1,1> beta =
        Eigen::Matrix<local_scalar_t__,-1,1>::Constant(12, DUMMY_VAR__);
      current_statement__ = 1;
      beta = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(12);
                            ...
                            stan::math::add(
                              stan::math::add(
                                stan::math::add(
                                  ...
                                  stan::math::multiply(
                                    stan::model::rvalue(beta, "beta",
                                      stan::model::index_uni(2)), interest)),
                                stan::math::multiply(
                                  stan::model::rvalue(beta, "beta",
                                    stan::model::index_uni(3)), male)),
                              stan::math::multiply(
                                stan::model::rvalue(beta, "beta",
                                  stan::model::index_uni(4)), over65)),
                            stan::math::multiply(
                              stan::model::rvalue(beta, "beta",
                                stan::model::index_uni(5)), white)),
                          stan::math::multiply(
                            stan::model::rvalue(beta, "beta",
                              stan::model::index_uni(6)), immig)),
                        stan::math::multiply(
                          stan::model::rvalue(beta, "beta",
                            stan::model::index_uni(7)), educ_r)),
                      stan::math::multiply(
                        stan::model::rvalue(beta, "beta",
                          stan::model::index_uni(8)), workmos)),
                    stan::math::multiply(
                      stan::model::rvalue(beta, "beta",
                        stan::model::index_uni(9)), workhrs_top)),
                  stan::math::multiply(
                    stan::model::rvalue(beta, "beta",
                      stan::model::index_uni(10)), any_ssi)),
                stan::math::multiply(
                  stan::model::rvalue(beta, "beta",
                    stan::model::index_uni(11)), any_welfare)),
              stan::math::multiply(
                stan::model::rvalue(beta, "beta", stan::model::index_uni(12)),
                any_charity)), sigma)));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "earnings2_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      Eigen::Matrix<double,-1,1> beta =
        Eigen::Matrix<double,-1,1>::Constant(12,
          std::numeric_limits<double>::quiet_NaN());
      current_statement__ = 1;
      beta = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(12);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      stan::model::assign(beta,
        in__.read<Eigen::Matrix<local_scalar_t__,-1,1>>(12),
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(12) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (12 + 1);
...
using stan_model = earnings2_model_namespace::earnings2_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return earnings2_model_namespace::profiles__;
}
#endif